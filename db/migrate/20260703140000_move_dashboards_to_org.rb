...
# now belongs to the org and each panel carries its own island_id (any server
...
class MoveDashboardsToOrg < ActiveRecord::Migration[8.1]
  def up
    remove_foreign_key :metric_dashboards, :islands
    remove_index :metric_dashboards, name: "index_metric_dashboards_on_island_id_and_name"
    remove_index :metric_dashboards, name: "index_metric_dashboards_one_pinned_per_island"
    remove_index :metric_dashboards, name: "index_metric_dashboards_on_island_id"
    remove_column :metric_dashboards, :island_id
