class AddRegionAndInfraToServers < ActiveRecord::Migration[8.1]
  # Free-text metadata the operator fills in at server registration.
  # The controller has no notion of region or infra — these labels
  # exist purely so the WebUI's topbar can surface "fra1 · hetzner"
  # next to the server name. No uniqueness, no validation, no enum:
