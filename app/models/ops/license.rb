...
# Ops::License — an activated license, stored so renewal does not need a restart.
#
# The upgrade path this exists for: someone runs the free tier, decides they
# want more, buys a license, pastes the token into Settings, and is Enterprise
...
# upgrade, and who did it" during a support conversation. The ACTIVE license is
# whichever has the newest issued_at — see LicenseToken.resolve, where a token in the
# environment competes on the same footing.
#
# Nothing here decides whether a license is any good. Verification lives in
...
class Ops::License < ApplicationRecord
  ...
  # sit in Settings looking like a license and behaving like nothing.
